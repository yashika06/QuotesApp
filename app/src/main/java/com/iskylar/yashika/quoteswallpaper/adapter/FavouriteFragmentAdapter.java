...
public class FavouriteFragmentAdapter extends RecyclerView.Adapter<FavouriteFragmentAdapter.ViewHolder> {
    ...
    public FavouriteFragmentAdapter(Context context, int resource, ArrayList<Integer> datalist) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            this.imageView = (ImageView) itemView.findViewById(R.id.fav_imageview);
        }
    }
}
